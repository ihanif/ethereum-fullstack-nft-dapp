...
contract StarNotary is ERC721 {
    ...
    string public name = "StarNotary NFT";
    string public symbol = "SNF";
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require(
            token1Owner == msg.sender || token2Owner == msg.sender,
            "Owner of token 1 or token2 needs to be the sender"
        );
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        require(
            ownerOf(_tokenId) == msg.sender,
            "Can't transfer stars that you don't own"
        );
